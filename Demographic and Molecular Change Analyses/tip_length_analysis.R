...
corresponding_PERSON_ID <- sequenced_individual_detailed_metadata$PERSON_ID[match(tip_labels, sequenced_individual_detailed_metadata$strain)]
filtered_tree <- distance_tree
filtered_tree$tip.label <- corresponding_PERSON_ID
ages <- sequenced_individual_detailed_metadata$age_at_infection[match(corresponding_PERSON_ID, sequenced_individual_detailed_metadata$PERSON_ID)]
regions <- sequenced_individual_detailed_metadata$REGIONSKODE[match(corresponding_PERSON_ID, sequenced_individual_detailed_metadata$PERSON_ID)]
sex <- sequenced_individual_detailed_metadata$KOEN[match(corresponding_PERSON_ID, sequenced_individual_detailed_metadata$PERSON_ID)]
partial_vacc <- sequenced_individual_detailed_metadata$Partially_vaccinated_at_exposure[match(corresponding_PERSON_ID, sequenced_individual_detailed_metadata$PERSON_ID)]
fully_vacc <- sequenced_individual_detailed_metadata$Fully_vaccinated_at_exposure[match(corresponding_PERSON_ID, sequenced_individual_detailed_metadata$PERSON_ID)]
date <- sequenced_individual_detailed_metadata$date[match(corresponding_PERSON_ID, sequenced_individual_detailed_metadata$PERSON_ID)]
major_variant <- sequenced_individual_detailed_metadata$variant[match(corresponding_PERSON_ID, sequenced_individual_detailed_metadata$PERSON_ID)]
PERSON_ID <- sequenced_individual_detailed_metadata$PERSON_ID[match(corresponding_PERSON_ID, sequenced_individual_detailed_metadata$PERSON_ID)]
...
corresponding_PERSON_ID_time <- sequenced_individual_detailed_metadata$PERSON_ID[match(time_tip_labels, sequenced_individual_detailed_metadata$strain)]
